...
// tag::EN[]
[[LG-5-1]]
==== LG 5-1: Distinguish as-is, to-be, human-facing, and agent-facing architecture documentation
...
[[LG-5-2]]
==== LG 5-2: Maintain architectural decisions and documentation through agentic development loops
...
[[LG-5-3]]
==== LG 5-3: Use AI and agents to extract architectural information from existing system parts
...
[[LG-5-4]]
==== LG 5-4: Generate architectural views from gathered architectural information
